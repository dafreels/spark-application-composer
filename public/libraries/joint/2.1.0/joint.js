...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['public/libraries/backbone/1.3.3/backbone', 'lodash/3.10.1/lodash', 'jquery'], function(Backbone, _, $) {
        ...
        var Backbone = require('public/libraries/backbone/1.3.3/backbone');
        var _ = require('public/libraries/lodash/3.10.1/lodash');
...
joint.dia.LinkView = joint.dia.CellView.extend({
    ...
    _markAvailableMagnets: function(data) {
        ...
        function isMagnetAvailable(view, magnet) {
            ...
            return validate.apply(paper, this.validateConnjoint.dia.PaperectionArgs(view, magnet));
        }
